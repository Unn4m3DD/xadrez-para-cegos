  ...
  pieces: {
    ...
    pawn: {
      positions: [
        ...
        { x: 2, y: 1, image: "WP3", image_mirrored: "BP2" },
        { x: 3, y: 1, image: "WP4", image_mirrored: "BP3" },
        { x: 4, y: 1, image: "WP5", image_mirrored: "BP4" },
        { x: 5, y: 1, image: "WP6", image_mirrored: "BP5" },
        { x: 6, y: 1, image: "WP7", image_mirrored: "BP6" },
        { x: 7, y: 1, image: "WP8", image_mirrored: "BP7" },
      ],
      mirrored: true,
      owner: 0,
    },
